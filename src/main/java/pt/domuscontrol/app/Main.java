...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 3 -> menuAutomacoes.mostrar();
                case 4 -> System.out.println("  [Em desenvolvimento - Cenários]");
                case 5 -> System.out.println("  [Em desenvolvimento - Sugestões]");
                case 6 -> menuAvancarTempo(bd, automacaoService);
                case 7 -> guardar(bd);
    ...
    /**
     * Avança o tempo e verifica automaticamente os escalonamentos.
     * Assim o utilizador vê em tempo real quais escalonamentos dispararam.
     */
    private static void menuAvancarTempo(BaseDados bd, AutomacaoService automacaoService) {
        ...
        switch (op) {
            ...
            default -> { ConsoleUtils.imprimirErro("Opção inválida."); return; }
        }
